...
<body>
  <div class="container-fluid" id="headings">
	...
	<div class="home-box custome-box ">
		<h1 align="center">Welcome To The World of<br/> Java Programming!</h1>
		<br/>
	...
	<div class="quiz-box custome-box hide">
		...
		<div class="next-question-btn">
			<button type="button" class="btn" onclick=""><a href="quiz_java.php" style="color: white;">Back</a></button>
	...
	<div class="result-box custome-box hide">
		...
		<a href="c_courses.php#java"<button type="button" class="btn">Go To Home</button></a>
	</div>


	<script type="text/javascript" src="js/question_java.js"></script>
