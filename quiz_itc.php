...
<body>
  <div class="container-fluid" id="headings">
	...
	<div class="home-box custome-box ">
		<h1 align="center">Welcome To The World of<br/> Information theory!</h1>
		<br/>
	...
	<div class="quiz-box custome-box hide">
		...
		<div class="next-question-btn">
			<button type="button" class="btn" onclick=""><a href="quiz_itc.php" style="color: white;">Back</a></button>
	...
	<script type="text/javascript" src="js/question_itc.js"></script>
