...
<body>
  <div class="container-fluid" id="headings">
	...
	<div class="home-box custome-box ">
		<h1 align="center">Welcome To The World of<br/> Signals and Systems!</h1>
		<br/>
	...
	<div class="quiz-box custome-box hide">
		...
		<div class="next-question-btn">
			<button type="button" class="btn" onclick=""><a href="quiz_sns.php" style="color: white;">Back</a></button>
	...
	<div class="result-box custome-box hide">
		...
		<a href="e_courses.php"<button type="button" class="btn">Go To Home</button></a>
	</div>


	<script type="text/javascript" src="js/question_sns.js"></script>
