...
<body>
  <div class="container-fluid" id="headings">
	...
	<div class="home-box custome-box ">
		<h1 align="center">Welcome To The World of<br/> C++ Programming!</h1>
		<br/>
	...
	<div class="quiz-box custome-box hide">
		...
		<div class="next-question-btn">
			<button type="button" class="btn" onclick=""><a href="quiz_cpp.php" style="color: white;">Back</a></button>
	...
	<script type="text/javascript" src="js/question_cpp.js"></script>
